...
public class SuccessNotificationHandler extends BaseScreenHandler {
    public static Logger LOGGER = Utils.getLogger(SuccessNotificationHandler.class.getName());
    @FXML
    private Button home;
     ...
     * @throws IOException
     */
    public SuccessNotificationHandler(Stage stage, String screenPath) throws IOException {
