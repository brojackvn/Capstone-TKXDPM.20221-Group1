...
public class ViewRentBikeHandler extends BaseScreenHandler {
    ...
    public void setInfo() throws SQLException {
        ...
        Rent.addToTimeList(new Timestamp(System.currentTimeMillis()));
        time.setText(String.valueOf(Rent.thoigiandathue()) + " minutes");
