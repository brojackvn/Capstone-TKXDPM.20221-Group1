...
//        Rectangle clip = new Rectangle(bikeImage.getFitWidth(), bikeImage.getFitHeight());
//        clip.setArcWidth(50);
//        clip.setArcHeight(50);
//        bikeImage.setClip(clip);
//
//        SnapshotParameters parameters = new SnapshotParameters();
//        parameters.setFill(Color.TRANSPARENT);
//        WritableImage image = bikeImage.snapshot(parameters, null);
//        bikeImage.setClip(null);
//        bikeImage.setEffect(new DropShadow(20,Color.RED));
        bikeImage.setImage(img2);
    }
